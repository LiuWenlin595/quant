...
def get_stock_industry(industry_name,date,output_csv = False):
    ...
    for ind in industries:
        ...
        industry_stocks = set(all_securities.index) & set(industry_stocks)
        all_securities.loc[industry_stocks, 'industry_code'] = ind
...
def neutralize(data,date,market_cap,industry_name='sw_l1'):
    ...
    industry_se = np.array(industry_se.loc[index,0].tolist())
