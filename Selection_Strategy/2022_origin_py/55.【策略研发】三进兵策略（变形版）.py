...
def initialize(context):
    log.info('运行[initialize]函数，时间节点：{}'.format(context.current_dt))
...
def trade_func(context):
    log.info('运行[trade_func]函数，时间节点：{}'.format(context.current_dt))
...
def after_trading_end(context):
    log.info('运行[after_trading_end]函数，时间节点：{}'.format(context.current_dt))
